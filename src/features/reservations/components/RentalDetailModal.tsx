...
export function RentalDetailModal() {
    ...
    const seatEstimate = estimateSeats(items)
                                    ...
                                    {seatEstimate && (
                                        <div className="space-y-1 md:col-span-3 border-t border-gray-100 pt-4">
                                            <p className="text-[10px] font-bold text-purple-600 uppercase tracking-tighter">
                                                {seatEstimate.source === 'plaza' ? 'Plazas' : 'Plazas Estimadas'}
                                            </p>
                                            <div className="flex items-center gap-2">
                                                <span className="inline-flex items-center gap-1.5 bg-purple-50 border border-purple-200 text-purple-800 text-sm font-black px-3 py-1 rounded-full">
                                                    ...
                                                    {seatEstimate.seats} plazas
                                                </span>
                                                <span className="text-[10px] text-gray-400 italic">
                                                    {seatEstimate.source === 'plaza' ? 'precio por plaza' : 'estimado por sillas'}
                                                </span>
                                            </div>
                                        </div>
                                    )}
